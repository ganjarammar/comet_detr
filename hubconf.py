...
def _make_detr(backbone_name: str, dilation=False, num_classes=6, mask=False):
    hidden_dim = 256
...
def detr_resnet50(pretrained=False, num_classes=6, return_postprocessor=False):
    """
...
def detr_resnet50_dc5(pretrained=False, num_classes=6, return_postprocessor=False):
    """
